...
class AnalizadorPreguntasCerradas:
    ...
    def aplicar_analisis_preguntas(self,num_procesador):
        ...
        logger_proc.debug(f"✔️ Preguntas cerradas: {len(self.preguntas)} ")
        ...
        logger_proc.debug(f" ✔️ Preguntas sin contexto detectadas: {self.cant_preg_sin_contexto} ")
        ...
        logger_proc.debug(f" ✅ Cantidad de Preguntas a Procesar: {total_reg_preguntas}")
        ...
        logger_proc.debug(f" ✅ Cantidad de Respuestas a Procesar: {self.cant_respuestas}")
